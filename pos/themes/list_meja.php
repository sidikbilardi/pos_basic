...
<?php
	...
	if($_GET['id'] == 'booking'){
		include"../table/table_booking_list.php";
	}else{
		?>
	...
	?>	
		...
		<div class="col-lg-1 col-md-2 col-xs-4 col-sm-3">
			...
			<a href="themes/pilihan.php?meja=<?php echo $rd['kode_meja']; ?>&trx=<?php echo $rd['no_bukti']; ?>&svc=<?php echo $_GET['svc']; ?>&tax=<?php echo $_GET['tax']; ?>&name=<?php echo $rd['nama_meja']; ?>" class="fancybox fancybox.ajax">
			...
			<?php }else{ 
				...
				?>
			<a href="themes/pilihan.php?status=<?php echo $rd['status_meja']; ?>&meja=<?php echo $rd['kode_meja']; ?>&trx=<?php echo $rd['no_bukti']; ?>&svc=<?php echo $_GET['svc']; ?>&tax=<?php echo $_GET['tax']; ?>&name=<?php echo $rd['nama_meja']; ?>" class="fancybox fancybox.ajax">
