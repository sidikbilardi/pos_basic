            ...
            <aside class="right-side">
				...
				<div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Kitchen Display</h3>
                                </div><!-- /.box-header -->
                                ...
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody  id="transkitchen">
								<?php 
								$no = 1;
$rs = mysql_query("SELECT * from (SELECT no_bukti,kode_menu,qty as jumlah,keterangan FROM tbltransorder_detail WHERE zstatus = '' AND keterangan = '' AND LEFT(kode_menu,3) != 'CMT' AND LEFT(kode_menu,3) != 'DSC' GROUP by no_bukti,kode_menu) A 
		LEFT JOIN 
...
$no++;
	...
	$(document).ready(function() {
   		var refreshId = setInterval(function() {
      		$("#transkitchen").load('inc/list_kitchen.php?randval='+ Math.random());
   		}, 5000);
	...
	function doStartKitchen(id,trx) {
		$.ajax({
			...
			success: function(msg){
				$("#transkitchen").load("inc/list_kitchen.php");
